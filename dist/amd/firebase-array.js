define(["exports", "./firebase-utils", "./array-sync-manager"], function (exports, _firebaseUtils, _arraySyncManager) {
  "use strict";
  ...
  var FirebaseArray = (function () {
    function FirebaseArray(ref) {
      ...
      this.firebaseUtils = new _firebaseUtils.FirebaseUtils();
      this._sync = new _arraySyncManager.ArraySyncManager(this);
